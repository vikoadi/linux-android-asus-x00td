...
# Kernel base version
KERNEL_BASE_VERSION = 4.4.223

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = androidboot.console=ttyMSM0 earlycon=msm_serial_dm,0xc170000 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 sched_enable_hmp=1 sched_enable_power_aware=1 service_locator.enable=1 swiotlb=1 firmware_class.path=/vendor/firmware_mnt/image loop.max_part=7 apparmor=1 security=apparmor audit=0 selinux=0 console=tty0 droidian.lvm.prefer
...
DEVICE_FULL_NAME = Asus Zenfone Max Pro M1
...
# Defconfig to use
KERNEL_DEFCONFIG = X00TD-perf_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/sdm636-qrd-X00TD.dtb
...
FLASH_INFO_MANUFACTURER = Asus

# Device model. This must match the `ro.product.vendor.model`
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Zenfone Max Pro M1
